...
public class EntityThrowablePokeball extends BaseEntityThrowablePokeball{
	...
	public EntityThrowablePokeball(World worldIn) {
		super(worldIn);
	}
	
	public EntityThrowablePokeball(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}
	
	@SideOnly(Side.CLIENT)
	public EntityThrowablePokeball(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}
	...
	protected void onImpact(RayTraceResult result) {
		...
		if(result.entityHit != null) {
			...
			result.entityHit.entityDropItem(new ItemStack(Pokeballs.POKEBALL, rand), 0.5f);
		}
	}
